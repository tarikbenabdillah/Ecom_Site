...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.ref,a.name,a.price,a.image,b.id,b.qty FROM products a,cart b WHERE a.ref=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.ref,a.name,a.price,a.image,b.id,b.qty FROM products a,cart b WHERE a.ref=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@MYSHOPastro.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/MYSHOP-app-h/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/MYSHOP-app-h/cancel.php"/>
